...
#Purpose: The script aims to flag Windows services that might be misconfigured or malicious by checking for:

#Binaries running from a user directory.
#Services running with high privileges (LocalSystem).
#Missing descriptions.
#Unsigned executables.
#(Optionally) Services with short or high entropy names and suspicious file extensions.
